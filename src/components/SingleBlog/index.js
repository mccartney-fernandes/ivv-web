...
export default function SingleBlog({ post }) {
  function countComments (comments) {
    ...
    return countComments.length <= 1 ? `${countComments.length} Comentário` : `${countComments.length} Comentários`;
  }
  return (
			...
			<div className="container">
					<div className="row">
                          ...
                          <ul className="blog-info-link mt-3 mb-4">
                              <li><i className="far fa-calendar-alt" /> {reOrderDate(post.data)}</li>
                              <li><i className="far fa-comments"/> {countComments(post.comments)} </li>
                            </ul>
													<p className="excert">
                          {post.content}
													</p>
                                      ...
                                      <div className="desc">
                                          ...
                                          <div className="d-flex justify-content-between">
                                            <div className="d-flex align-items-center">
                                              ...
                                              <p className="date">{reOrderDate(comments.data)}</p>
                                            </div>
                                          </div>
